        ...
        <Card>
          ...
          <CardContent>
            <Button asChild className="w-full">
              <Link href="/billing/charges/generate">Generate Rent Charges</Link>
            </Button>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            <Button asChild className="w-full">
              <Link href="/billing/payments/new">Record Payment</Link>
            </Button>
          </CardContent>
        </Card>
      </div>
      ...
      <div>
        ...
        {outstandingCharges.length === 0 ? (
          <EmptyState
            ...
            actionHref="/billing/charges/generate"
          />
        ) : (
              ...
              <TableBody>
                {outstandingCharges.map((charge) => (
                  <TableRow key={charge.id}>
                    ...
                    <TableCell>
                      <Link
                        href={`/tenants/${charge.lease.tenant.id}`}
